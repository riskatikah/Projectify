...
class ViewApplicationPage2 extends StatelessWidget {
  final String applicationId;

  ViewApplicationPage2({required this.applicationId});
      ...
      body: Container(
        ...
        child: FutureBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            String userId = applicationData['userId'] ?? '';
                ...
                children: [
                  ...
                  Center(
                    child: ElevatedButton(
                      ...
                      child: Text('View User Profile', style: TextStyle(fontSize: 16)),
                    ),
                  ),
                ],
              ),
